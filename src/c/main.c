...
static void init(void) {
  ...
  date_layer = text_layer_create(GRect(0, 84, frame.size.w /* width */, 50/* height */));
  text_layer_set_text_color(date_layer, GColorWhite);
  text_layer_set_background_color(date_layer, GColorClear);
  text_layer_set_font(date_layer, fonts_get_system_font(FONT_KEY_ROBOTO_CONDENSED_21));
  text_layer_set_text_alignment(date_layer, GTextAlignmentCenter);

  bt_layer = text_layer_create(GRect(0, 120, /* width */ frame.size.w, 34 /* height */));
  text_layer_set_text_color(bt_layer, GColorWhite);
  ...
  battery_layer = text_layer_create(GRect(0, 140, /* width */ frame.size.w, 34 /* height */));
  text_layer_set_text_color(battery_layer, GColorWhite);
